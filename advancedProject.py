#Shu Raturi
#Use i2c LCD, MPU6050, DHT11 and a rotary encoder
#Gets data from the sensors such as temperature, humidity and tilt angle then displays that to the i2c LCD which updates in real time as the data changes.
#The screen has different pages which can be switched with the use of the rotary encoder.
